...
export default function AllEmployee() {
  ...
  const data = [
    { email: "example1@example.com", username: "user1", action: "edit/delete" },
    { email: "example2@example.com", username: "user2", action: "edit/delete" },
    { email: "example3@example.com", username: "user3", action: "edit/delete" },
  ];
